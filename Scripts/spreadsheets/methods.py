...
def get_po_number(workbook, cells):
    """Returns the value for the Purchase Order Number"""
...
def get_ship_to_name(workbook, cells):
    """Returns the value for the Ship-To Name"""
    return get_cell_value(workbook, cells["shipTo"])
...
def get_total_quantity(workbook, cells):
    """Returns the value for the Total Quantity"""
